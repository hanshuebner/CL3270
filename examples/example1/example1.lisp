...
(defparameter example1-screen1
  (make-screen
   ...
   (make-instance 'field :row 14 :col 0
               :content "Detected codepage:")
   (make-instance 'field :row 14 :col 20 :name "codepage")
   (make-instance 'field :row 15 :col 0
